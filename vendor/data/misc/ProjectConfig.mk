...
CUSTOM_HAL_IMGSENSOR = pascald_truly_main_ov13b10 pascald_qtech_main_ov13b10 pascald_hlt_front_gc5035 pascald_shengtai_front_gc5035 pascald_shengtai2_front_gc5035 pascald_hlt_front_s5k4h7 pascal_shengtai_wide_ov8856 pascald_hlt_depth_gc02k0b pascald_hlt_depth_gc02m1b pascal_hlt_mono_gc02m1b pascal_shengtai_mono1_ov02b1b pascal_lhyx_mono1_ov02b1b pascale_hlt_macro_ov02b10 pascald_cxt_depth_gc02m1b pascald_lhyx_depth_ov02b1b pascal_cxt_mono1_gc02m1b pascal_cxt_mono_ov02b1b
CUSTOM_HAL_MAIN3_IMGSENSOR = pascald_hlt_depth_gc02k0b
CUSTOM_HAL_MAIN2_IMGSENSOR = pascal_shengtai_mono1_ov02b1b
CUSTOM_HAL_MAIN_IMGSENSOR = pascald_truly_main_ov13b10 pascald_qtech_main_ov13b10
CUSTOM_HAL_MSENSORLIB = akl akm memsic
CUSTOM_HAL_SENSORS = sensor
CUSTOM_HAL_SUB_IMGSENSOR = pascald_hlt_front_gc5035 pascald_shengtai_front_gc5035 pascald_shengtai2_front_gc5035 pascald_hlt_front_s5k4h7
...
CUSTOM_KERNEL_IMGSENSOR = pascald_truly_main_ov13b10 pascald_qtech_main_ov13b10 pascald_hlt_front_gc5035 pascald_shengtai_front_gc5035 pascald_shengtai2_front_gc5035 pascald_hlt_front_s5k4h7 pascal_shengtai_wide_ov8856 pascald_hlt_depth_gc02k0b pascald_hlt_depth_gc02m1b pascal_hlt_mono_gc02m1b pascal_shengtai_mono1_ov02b1b pascal_lhyx_mono1_ov02b1b pascale_hlt_macro_ov02b10 pascald_cxt_depth_gc02m1b pascald_lhyx_depth_ov02b1b pascal_cxt_mono1_gc02m1b pascal_cxt_mono_ov02b1b
CUSTOM_KERNEL_IN_POCKET_SENSOR = no
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_MAGNETOMETER = yes
CUSTOM_KERNEL_MAIN3_IMGSENSOR = pascald_hlt_depth_gc02k0b
CUSTOM_KERNEL_MAIN2_IMGSENSOR = pascal_shengtai_mono1_ov02b1b
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN_IMGSENSOR = pascald_truly_main_ov13b10 pascald_qtech_main_ov13b10
...
CUSTOM_KERNEL_SUB_IMGSENSOR = pascald_hlt_front_gc5035 pascald_shengtai_front_gc5035 pascald_shengtai2_front_gc5035 pascald_hlt_front_s5k4h7
...
# ifeq ($(ODM_WT_EDIT),yes)
# Xin.Kou@ODM_WT.NW.Config, 2020/03/27, Modify Modem Floder Name
CUSTOM_MODEM=oppo6765_ALL
# endif
...
# ifeq ($(ODM_WT_EDIT),yes)
# Shouxing.Tang@ODM_WT.MM.Audiodriver.Hal, 2020/03/27,single mic
MTK_AUDIO_NUMBER_OF_MIC = 1
# endif
MTK_AUDIO_NUMBER_OF_SPEAKER = 1
# ifeq ($(ODM_WT_EDIT),yes)
# Shouxing.Tang@ODM_WT.MM.Audiodriver.Hal, 2020/03/27,change speaker path
...
# ifeq ($(ODM_WT_EDIT),yes)
# Shouxing.Tang@ODM_WT.MM.Audiodriver.Hal, 2020/04/13,use dirac audio effect,disable mtk algo
...
MTK_BWC_SUPPORT = yes
# ifeq ($(ODM_WT_EDIT),yes)
# Xin.Kou@ODM_WT.NW.Config, 2020/03/27, Sync with Monet and disable C2K
MTK_C2K_LTE_MODE = 0
# endif
MTK_CAMERA_APP = no
...
# ifeq ($(ODM_WT_EDIT),yes)
# Shouxing.Tang@ODM_WT.MM.Audiodriver.Hal, 2020/03/27,for single mic
MTK_DUAL_MIC_SUPPORT = no
#end
MTK_DVFS_DISABLE_LOW_VOLTAGE_SUPPORT = no
MTK_DX_HDCP_SUPPORT = no
# ifeq ($(ODM_WT_EDIT),yes)
# Nan.Liu@ODM_WT.NW.Config, 2020/05/15, Modify for CCCI Log from 22M to 12M
MTK_DYNAMIC_CCB_BUFFER_GEAR_ID = 2
# endif
...
# ifeq ($(ODM_WT_EDIT),yes)
# Hainan.Jia@ODM_WT.NW.SIM, 2020/04/10, Modify for enabling VSIM
...
MTK_FMRADIO_APP = yes
# ifeq ($(ODM_WT_EDIT),yes)
# Shouxing.Tang@ODM_WT.MM.Audiodriver.Machine, 2020/04/13, add for 50KHz space support
...
#ifdef ODM_WT_EDIT
#Rongbiao.Huang@ODM_WT.AD.OppoLog.MTKLOG, 2020/04/09. Modify for MT6765 to put the MTKLog to compile process for buildtype-user
...
# ifeq ($(ODM_WT_EDIT),yes)
# Nan.Liu@ODM_WT.NW.Config, 2020/04/07, Modify for disable cdma & TDSCDMA
MTK_MD1_SUPPORT = 9
# endif
MTK_MD3_SUPPORT = 0
...
# ifdef ODM_WT_EDIT
# Qun.Lin@ODM_WT.Memroy.Performance, 2020/05/19,diable MTK_MMPROFILE_SUPPORT to increase avilable ram
MTK_MMPROFILE_SUPPORT = no
# endif /* ODM_WT_EDIT */
#ifdef ODM_HQ_EDIT
#hebo@ODM_HQ.Network.Modem 2512920, 2019/11/01,disable cta feature as it block send data
...
#ifeq ($(ODM_WT_EDIT),yes)
# Qun.Lin@ODM_WT.Android.Performance, 2020/04/17, disable MTK_PRIVACY_PROTECTION_LOCK
...
#ifeq ($(ODM_WT_EDIT),yes)
# Xin.Kou@ODM_WT.NW.SIM, 2020/03/27, SIM HOT SWAP config
...
MTK_TEE_SUPPORT = yes
##ifdef VENDOR_EDIT
#Yuchun.Luo@RM.NW.IMS,2019/11/12
#modify for enable Telephony Log Debug
...
#ifdef VENDOR_EDIT
#Yongan.Lin@RM.NW.SIM.1602119, 2019/12/30,modify for notify sml info
#SIM_ME_LOCK_MODE = 0
#else  /*VENDOR_EDIT*/
SIM_ME_LOCK_MODE = 3
#endif /*VENDOR_EDIT*/
...
# ifeq ($(ODM_WT_EDIT),yes)
# Hong.Zhang@ODM_WT.MM.Display.Config,2020/04/06, Multimedia tuner feature
MTK_APP_RESOLUTION_TUNER_SUPPORT = no
# endif
MTK_DTBO_UPGRADE_FROM_ANDROID_O = no
MTK_CAM_HAL_VERSION = 3
#ifeq ($(ODM_WT_EDIT),yes)
# Qun.Lin@ODM_WT.Android.Performance, 2020/04/17, disable MTK_DURASPEED_SUPPORT
...
# ifeq ($(ODM_WT_EDIT),yes)
# Hainan.Jia@ODM_WT.NW.SIM, 2020/04/16, enable for OMAPI for single SIM switch
...
# ifeq ($(ODM_WT_EDIT),yes)
# Hainan.Jia@ODM_WT.NW.SIM, 2020/04/10, Modify for sim on/off MTK_SIM_CARD_ONOFF = 1 -> 2
...
MTK_BT_INTEROP_LIST_TC16 = yes
MTK_GWSD_SUPPORT = yes

#ifdef VENDOR_EDIT
#Bin.Li@BSP.Fingerprint.Basic, 2018/01/25, add for open soter.
